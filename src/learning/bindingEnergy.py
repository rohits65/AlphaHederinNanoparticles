...
def clean_data() -> tuple:
    ...
    x_values = data[['TPSA', 'CX', 'MPS', 'MW', 'LToG']].to_numpy().reshape(-1, 5)  # Change last number to # of params
...
'''
regr = MLPRegressor(solver='lbfgs', alpha=0.4, hidden_layer_sizes=(6, 3), random_state=2, max_iter=1000)
...
def processData(raw_x_data, raw_y_data):
...
print(regr.predict([[129, 383, 135.0, 243.22, 1]]))
